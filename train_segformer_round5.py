"""train_segformer_round5.py — SegFormer-B4, 5-Class Round 5
Classes : 0=Background  1=Fibrin  2=Granulation  3=Callus  4=Necrotic
Changes vs Round 4:
  - เพิ่ม Segmentation-ulcer dataset (Sloughy->Fibrin, Granulation, Necrotic)
    เพื่อเสริม Fibrin ที่ Dice ต่ำ (0.5639 ใน eval Round 4)
  - เพิ่ม CLASS_WEIGHTS ของ Fibrin และ Callus (สอง class ที่ยังอ่อน)
  - ลด LR ลงอีกขั้น (fine-tune ต่อจาก Round 4 best ซึ่ง converge เร็วที่ Ep1)
  - Loads from Round 4 best (segformer_b4_5class_r4_best.pth) with strict=True
  - Saves to segformer_b4_5class_r5_best.pth (does NOT overwrite Round 4)
  - Per-dataset val Dice printed each epoch for easier debugging
  - history saved to history_5class_r5.json
"""
